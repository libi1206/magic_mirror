...
public class SpeakTool {
    private static final String APP_ID = "11551111";//"14454479";
    private static final String API_KEY = "plE8e5bxfGYGjefOG6h1ddMU";//"plE8e5bxfGYGjefOG6h1ddMU";
    private static final String SECRET_KEY = "IoZdB01rfcTDBAGkeE6jImGFc1dIG55u";//"IoZdB01rfcTDBAGkeE6jImGFc1dIG55u ";
    ...
    public SpeakTool(Activity activity,String text,TextView textView ) {
        mActivity = activity;
        speakText = text;
